  ...
  return (
    <>
      ...
      <div className="relative flex justify-center">
        <BlobCenter className="hidden md:inline-block mix-blend-soft-light opacity-10 absolute z-0 transform -translate-y-40  translate-x-full " />
        <BlobCenter className="hidden md:inline-block mix-blend-soft-light opacity-10 absolute z-0 transform rotate-180 -translate-y-60  -translate-x-full " />
